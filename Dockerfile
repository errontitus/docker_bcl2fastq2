...
#
# To build, place this Dockerfile in a folder and then run the following command in that folder:
...
#
# TODO: document use of CPU number argument. E.g. cpu_num=<NUMBER OF CPUs>
